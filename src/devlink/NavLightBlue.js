...
import _styles from "./NavLightBlue.module.css";

export function NavLightBlue({ as: _Component = _Builtin.NavbarWrapper }) {
  return (
    <_Component
      className={_utils.cx(_styles, "navbar_light_blue")}
      tag="div"
      config={{
        animation: "default",
        collapse: "medium",
    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "container-33")} tag="div">
        <_Builtin.Block
        ...
        >
          ...
          >
            <_Builtin.Icon
              className={_utils.cx(_styles, "icon-3_darkversion")}
              widget={{
                type: "icon",
                icon: "nav-menu",
              }}
          ...
          >
            ...
            >
              <_Builtin.Link
                className={_utils.cx(_styles, "item_dark-home_blue")}
                button={false}
                block=""
                options={{
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "list-item_dark-home-new")}
                tag="div"
                delay={0}
                hover={true}
              >
                ...
                >
                  <_Builtin.Icon
                    className={_utils.cx(_styles, "icon-4bllue")}
                    widget={{
                      type: "icon",
                  ...
                  />
                  <_Builtin.Link
                    className={_utils.cx(_styles, "link-2_blue")}
                    button={false}
                    block=""
                    options={{
                      href: "#",
              ...
              >
                <_Builtin.Strong
                  className={_utils.cx(_styles, "phone_text_blue")}
                >
                  {"(905) 234-3323"}
                </_Builtin.Strong>
              </_Builtin.Link>
